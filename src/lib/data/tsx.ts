...
export const TSX_SYMBOLS: SymbolInfo[] = [
  ...
  // Broadening toward the TSX 60/Composite — more real, liquid,
  // single-class TSX names beyond the original curated set above. Same
  // caveat as the rest of this file: compiled from general knowledge, not
  // a live feed.
  { symbol: 'T.TO', name: 'TELUS Corp.', kind: 'stock' },
  { symbol: 'WFG.TO', name: 'West Fraser Timber Co. Ltd.', kind: 'stock' },
  { symbol: 'CFP.TO', name: 'Canfor Corp.', kind: 'stock' },
  { symbol: 'BYD.TO', name: 'Boyd Group Services Inc.', kind: 'stock' },
  { symbol: 'ERO.TO', name: 'Ero Copper Corp.', kind: 'stock' },
  { symbol: 'OSK.TO', name: 'Osisko Mining Inc.', kind: 'stock' },
  { symbol: 'OR.TO', name: 'Osisko Gold Royalties Ltd.', kind: 'stock' },
  { symbol: 'BLDP.TO', name: 'Ballard Power Systems Inc.', kind: 'stock' },
  { symbol: 'MEG.TO', name: 'MEG Energy Corp.', kind: 'stock' },
  { symbol: 'VET.TO', name: 'Vermilion Energy Inc.', kind: 'stock' },
  { symbol: 'FTT.TO', name: 'Finning International Inc.', kind: 'stock' },
  { symbol: 'NVA.TO', name: 'NuVista Energy Ltd.', kind: 'stock' },
  { symbol: 'POU.TO', name: 'Paramount Resources Ltd.', kind: 'stock' },
  { symbol: 'LB.TO', name: 'Laurentian Bank of Canada', kind: 'stock' },
  { symbol: 'ZZZ.TO', name: 'Sleep Country Canada Holdings Inc.', kind: 'stock' },
  { symbol: 'FSV.TO', name: 'FirstService Corp.', kind: 'stock' },
  { symbol: 'CIGI.TO', name: 'Colliers International Group Inc.', kind: 'stock' },
  { symbol: 'MFI.TO', name: 'Maple Leaf Foods Inc.', kind: 'stock' },
  { symbol: 'PBH.TO', name: 'Premium Brands Holdings Corp.', kind: 'stock' },
  { symbol: 'WEED.TO', name: 'Canopy Growth Corp.', kind: 'stock' },
  { symbol: 'ACB.TO', name: 'Aurora Cannabis Inc.', kind: 'stock' },
  { symbol: 'CRON.TO', name: 'Cronos Group Inc.', kind: 'stock' },
  { symbol: 'SSL.TO', name: 'Sandstorm Gold Ltd.', kind: 'stock' },
  { symbol: 'EDV.TO', name: 'Endeavour Mining Corp.', kind: 'stock' },
  { symbol: 'DPM.TO', name: 'Dundee Precious Metals Inc.', kind: 'stock' },
  { symbol: 'PSK.TO', name: 'PrairieSky Royalty Ltd.', kind: 'stock' },
  { symbol: 'SES.TO', name: 'Secure Energy Services Inc.', kind: 'stock' },
  { symbol: 'GSY.TO', name: 'goeasy Ltd.', kind: 'stock' },
  { symbol: 'MRE.TO', name: 'Martinrea International Inc.', kind: 'stock' },
  { symbol: 'BLX.TO', name: 'Boralex Inc.', kind: 'stock' },
  { symbol: 'INE.TO', name: 'Innergex Renewable Energy Inc.', kind: 'stock' },
  { symbol: 'TA.TO', name: 'TransAlta Corp.', kind: 'stock' },
  { symbol: 'CPX.TO', name: 'Capital Power Corp.', kind: 'stock' },
  { symbol: 'ALA.TO', name: 'AltaGas Ltd.', kind: 'stock' },
  { symbol: 'KEY.TO', name: 'Keyera Corp.', kind: 'stock' },
  { symbol: 'GEI.TO', name: 'Gibson Energy Inc.', kind: 'stock' },
  { symbol: 'BIPC.TO', name: 'Brookfield Infrastructure Corp.', kind: 'stock' },
  { symbol: 'BEPC.TO', name: 'Brookfield Renewable Corp.', kind: 'stock' },
  { symbol: 'BBUC.TO', name: 'Brookfield Business Corp.', kind: 'stock' },
  { symbol: 'WELL.TO', name: 'WELL Health Technologies Corp.', kind: 'stock' },
  { symbol: 'HUT.TO', name: 'Hut 8 Corp.', kind: 'stock' },
];
